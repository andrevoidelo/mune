...
const DraggableFab: React.FC<DraggableFabProps> = ({ onClick }) => {
  ...
  return (
    <button
      ...
      className={`fixed z-50 bg-primary text-on-primary p-4 rounded-full shadow-2xl shadow-black/50 touch-none select-none transition-transform duration-75 no-print ${isDragging ? 'scale-110 cursor-grabbing bg-primary-hover' : 'scale-100 cursor-pointer hover:bg-primary-hover active:scale-95'}`}
