      ...
      >
        ...
        >
          ...
          <div className="flex items-center gap-3 mb-6">
            ...
            <div>
               <h3 className="text-lg font-bold text-white leading-none">{pendingRoll.charName}</h3>
          ...
          <div className="space-y-6">
                ...
                <div className="bg-slate-800/50 rounded-xl p-4 border border-slate-700">
                   <div className="flex justify-between items-center mb-3">
                     ...
                     <span className="text-xs font-mono text-slate-500">
                       Alvo Final: <span className="text-white font-bold text-sm">{attr.value + rollConfig.modifier}</span>
                     </span>
                   </div>
                   ...
                   <div className="flex items-center gap-3">
                     ...
                     <div className="flex-1 text-center font-mono text-2xl font-black text-white bg-slate-900 rounded-lg py-2 border border-slate-700">
            ...
            <button
              onClick={executeRoll}
              className="w-full bg-amber-600 hover:bg-amber-500 text-white font-bold uppercase tracking-wider py-4 rounded-xl shadow-lg shadow-amber-900/20 active:translate-y-1 transition-all"
            >
              Rolar {attr.dice || 'd20'}
            </button>
          </div>
             ...
             <div className="flex flex-col items-center relative">
                ...
                {isRevealing ? (
                  ...
                  <div className="animate-in zoom-in spin-in-180 duration-500">
                    <span className={`text-6xl font-black ${!isNone && rollResult.isSuccess ? 'text-white' : (isNone ? 'text-blue-200' : 'text-slate-200')}`}>
                      {rollResult.roll}
                    </span>
                  </div>
                )}
      ...
      >
        ...
        >
          ...
          <p className="text-slate-300 mb-6 text-sm leading-relaxed">
            Deseja usar o item <span className="text-white font-bold">"{itemName}"</span>?
            <br />
        ...
        <div className="w-full landscape:w-[45%] landscape:h-full landscape:overflow-y-auto landscape:border-r border-slate-800 bg-slate-900 flex-none">
          ...
          <div className="relative w-full flex-none bg-slate-950 h-64 landscape:h-40">
            ...
            <div className="absolute bottom-0 left-0 right-0 p-4 pt-12 bg-gradient-to-t from-slate-900 to-transparent">
              <h2 className="text-3xl font-black text-white drop-shadow-md leading-none mb-1 line-clamp-2">{char.name}</h2>
                    ...
                    <div key={res.id} className="flex flex-col items-center justify-between p-2 rounded-lg border border-slate-700 bg-slate-800">
                      ...
                      <div className="flex items-center justify-between w-full bg-slate-900 rounded p-1">
                        <button 
                          ...
                          className="text-slate-400 hover:text-white p-1 hover:bg-slate-700 rounded transition-colors active:scale-90"
                        >
                          <Minus size={14} />
                        </button>
                        
                        <div className="flex flex-col items-center leading-none">
                           <span className="text-lg font-black text-white">{res.current}</span>
                      ...
                      return (
                        <div key={item.id} className="flex items-center justify-between p-3 bg-slate-800 rounded border border-slate-700">
                          ...
                          >
                            ...
                            <span className={`text-sm font-bold truncate transition-colors ${item.isPermanent ? 'text-blue-100 group-hover:text-white' : 'text-slate-200 group-hover:text-amber-500'}`}>
                              {item.name}
                            </span>
                            {diceNotation && (
                            ...
                            <div className="flex items-center gap-1 bg-slate-900 rounded p-1">
                              ...
                              {editingQtyId === item.id ? (
                                <input
                                  ...
                                  inputMode="numeric"
                                  pattern="[0-9]*"
                                  className="w-12 bg-slate-700 text-white text-center font-bold text-sm rounded py-1 outline-none border border-amber-500"
        ...
        <div className="max-w-3xl mx-auto w-full min-h-full">
          ...
          <div className="relative h-48 w-full flex-none bg-slate-950 group cursor-pointer" onClick={triggerFileUpload}>
            ...
            <div className="absolute inset-0 flex items-center justify-center">
              <span className="bg-slate-900/90 border border-slate-600 text-white px-5 py-2.5 rounded-full font-bold text-sm flex items-center gap-2 shadow-xl">
               ...
               <div className="bg-slate-800/50 p-4 rounded-xl border border-slate-700/50 space-y-4">
                 <div>
                   ...
                   <input 
                     ...
                     className="w-full bg-slate-800 border border-slate-700 rounded-lg p-3 text-white font-bold text-lg focus:border-amber-500 outline-none"
                 ...
                 <div>
                   ...
                   <textarea 
                     ...
                     className="w-full bg-slate-800 border border-slate-700 rounded-lg p-3 text-white text-sm focus:border-amber-500 outline-none min-h-[80px]"
                        ...
                        <div className="grid grid-cols-2 gap-2">
                            <div>
                              ...
                              <input 
                                ...
                                className="w-full bg-slate-900 rounded p-2 text-white font-mono text-center outline-none border border-slate-700 focus:border-amber-500"
                              />
                            </div>
                            <div>
                        ...
                        <div className="grid grid-cols-3 gap-2">
                          <div>
                            ...
                            <input 
                              ...
                              className="w-full bg-slate-900 rounded p-2 text-white font-mono text-center outline-none border border-slate-700 focus:border-amber-500 h-10"
                            />
                          </div>
                          <div>
                            ...
                            <select 
                              ...
                              className="w-full bg-slate-900 rounded px-2 text-white text-xs outline-none border border-slate-700 focus:border-amber-500 appearance-none h-10"
                            >
                          ...
                          <div>
                            ...
                            <input 
                              ...
                              className={`w-full bg-slate-900 rounded p-2 text-white font-mono text-center text-xs outline-none border ${isDiceEmpty ? 'border-red-500/60 focus:border-red-500' : 'border-slate-700 focus:border-amber-500'} h-10 placeholder-slate-600`}
                              placeholder="Ex: 1d20"
                            />
                          </div>
                        </div>
              ...
              <div className="bg-slate-800/50 p-3 rounded-lg border border-slate-700 mb-4">
                  <div className="flex flex-col gap-2">
                    <input 
                      ...
                      className="w-full bg-slate-900 border border-slate-700 rounded p-2 text-sm text-white outline-none focus:border-amber-500 placeholder-slate-600"
                    ...
                    <div className="flex gap-2">
                        <input 
                          ...
                          className="flex-1 bg-slate-900 border border-slate-700 rounded p-2 text-sm text-white outline-none focus:border-amber-500 placeholder-slate-600 font-mono"
                        ...
                        <button 
                          ...
                          className="px-4 bg-amber-600 hover:bg-amber-500 text-white rounded font-bold uppercase text-xs disabled:opacity-50 disabled:cursor-not-allowed"
                        >
                          Add
                        </button>
                    </div>
