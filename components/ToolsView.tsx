    ...
    return (
      <div className="h-full p-4 overflow-y-auto bg-slate-900">
        <div className="max-w-md mx-auto space-y-4">
           ...
           <input 
             className="w-full bg-slate-800 border border-slate-700 rounded p-3 text-white text-sm" 
           ...
           <div>
              ...
              <textarea 
                className="w-full h-40 bg-slate-800 border border-slate-700 rounded p-3 text-white text-sm font-mono"
                placeholder="Item 1&#10;Item 2&#10;Item 3"
                value={bulkItems}
      ...
      <div className="flex flex-col h-full bg-slate-900 relative">
        ...
        <div className="flex-none p-4 flex items-center justify-between gap-3 border-b border-slate-800 bg-slate-950 z-10">
           <div className="flex items-center gap-3">
              <button onClick={handleCloseCollection} className="p-2 bg-slate-800 rounded-full text-slate-400 hover:text-white">
                <ChevronLeft size={24} />
              </button>
              <div>
                <h2 className="text-lg font-bold text-white leading-none">{activeCollection.title}</h2>
               ...
               <div className="w-full max-w-sm min-h-[160px] bg-slate-800 border border-slate-700 rounded-xl p-6 flex flex-col items-center justify-center text-center shadow-lg transition-all landscape:h-full landscape:max-h-[80%]">
                  {tableResult ? (
                     <div className="animate-in fade-in zoom-in duration-200">
                        <h3 className="text-2xl font-bold text-white mb-1">{tableResult.text}</h3>
              ...
              {isDeck ? (
                <>
                   <button 
                     ...
                     className="w-full bg-amber-600 hover:bg-amber-500 disabled:opacity-50 disabled:bg-slate-700 text-white font-bold py-4 landscape:py-8 rounded-xl shadow-lg active:translate-y-1 transition-all flex items-center justify-center gap-2 text-lg"
                   >
                 ...
                 <button 
                   ...
                   className="w-full bg-amber-600 hover:bg-amber-500 text-white font-bold py-4 landscape:py-8 rounded-xl shadow-lg active:translate-y-1 transition-all flex items-center justify-center gap-2 text-lg"
                 >
            ...
            return (
              ...
              >
                 ...
                 <div className="flex-1">
                   <h3 className="font-bold text-white text-sm leading-tight line-clamp-1">{col.title}</h3>
